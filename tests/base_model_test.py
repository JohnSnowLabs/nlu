...
models_to_test = [
    ...
    NluTest(nlu_ref="en.explain_doc.era", lang='en', test_group='hc_pipeline', input_data_type='medical',
            library='healthcare'),
    NluTest(nlu_ref="en.med_ner.diseases en.resolve.icd10cm.augmented_billable", lang='en', test_group='hc_resolver',
    ...
    NluTest(nlu_ref="en.summarize.clinical_jsl", lang='en', test_group='hc_summarizer', input_data_type='medical',
            library='healthcare'),
    NluTest(nlu_ref="en.generate.generic_flan_base", lang='en', test_group='hc_generation', input_data_type='medical',
            library='healthcare'),
