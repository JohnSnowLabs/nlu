...
models_to_test = [
    ...
    NluTest(nlu_ref="en.classify.albert.imdb", lang='en', test_group='classifier', input_data_type='generic',
            library='open_source'),
    NluTest(nlu_ref="en.classify.bert_sequence.dehatebert_mono", lang='en', test_group='classifier', input_data_type='generic',
            library='open_source'),
    NluTest(nlu_ref="en.bert.zero_shot_classifier", lang='en', test_group='classifier', input_data_type='generic',library='open_source'),
    NluTest(nlu_ref="en.speech2text.wav2vec2.v2_base_960h", lang='en', test_group='classifier', input_data_type='asr',
            library='open_source'),
    ...
    NluTest(nlu_ref="pos", lang='en', test_group='classifier', input_data_type='generic',
            library='open_source'),
    NluTest(nlu_ref="en.distilbert.zero_shot_classifier", lang='en', test_group='classifier', input_data_type='generic',
            library='open_source'),
    NluTest(nlu_ref="tr.distilbert.zero_shot_classifier.allnli", lang='tr', test_group='classifier', input_data_type='generic',
            library='open_source'),
    ...
    NluTest(nlu_ref="questions", lang='en', test_group='classifier', input_data_type='generic',
            library='open_source'),
    NluTest(nlu_ref="en.roberta.zero_shot_classifier", lang='en', test_group='classifier', input_data_type='generic',
            library='open_source'),
    ...
    NluTest(nlu_ref="yake", lang='en', test_group='classifier', input_data_type='generic',
            library='open_source'),
    NluTest(nlu_ref="en.classify_image.base_patch16_224", lang='en', test_group='classifier', input_data_type='IMG_vit',
            library='open_source'),
    NluTest(nlu_ref="en.classify_image.swin.tiny", lang='en', test_group='classifier', input_data_type='IMG_vit',
            library='open_source'),
    NluTest(nlu_ref="en.answer_question.tapas.wikisql.base_finetuned", lang='en', test_group='classifier', input_data_type='tapas',
    ...
    NluTest(nlu_ref="glove", lang='en', test_group='embedding', input_data_type='generic',
            library='open_source'),
    NluTest(nlu_ref="bert en.embed.bert.small_L8_128  electra", lang='en', test_group='embedding', input_data_type='generic',
            library='open_source'),
    ...
    NluTest(nlu_ref="en.seq2seq.distilbart_cnn_6_6", lang='en', test_group='seq2seq', input_data_type='summarizer',
            library='open_source', pipe_params = [PipeParams('bart_transformer','setTask', 'summarize:'),PipeParams('bart_transformer','setMaxOutputLength',200)]),
    ...
    NluTest(nlu_ref="dep.untyped", lang='en', test_group='untyped_dependency', input_data_type='generic',
            library='open_source'),
    NluTest(nlu_ref="en.answer_question.squadv2.bert.base", lang='en', test_group='span_classifier',input_data_type='qa',
            output_levels=['chunk', 'tokens', 'embeddings'], library='open_source'),
    NluTest(nlu_ref="fr.answer_question.camembert.fquad", lang='en', test_group='span_classifier',input_data_type='qa',
            output_levels=['chunk', 'tokens', 'embeddings'], library='open_source'),
    NluTest(nlu_ref="en.answer_question.squadv2.deberta", lang='en', test_group='span_classifier',input_data_type='qa',
            output_levels=['chunk', 'tokens', 'embeddings'], library='open_source'),
    NluTest(nlu_ref="en.answer_question.squadv2.distil_bert.base_cased", lang='en', test_group='span_classifier', input_data_type='qa',
            output_levels=['chunk', 'tokens', 'embeddings'], library='open_source'),
    NluTest(nlu_ref="en.answer_question.squadv2.longformer.base", lang='en', test_group='span_classifier', input_data_type='qa',
            output_levels=['chunk', 'tokens', 'embeddings'], library='open_source'),
    NluTest(nlu_ref="en.answer_question.squadv2.roberta.base.by_deepset", lang='en', test_group='span_classifier', input_data_type='qa',
            output_levels=['chunk', 'tokens', 'embeddings'], library='open_source'),
    NluTest(nlu_ref="en.answer_question.squadv2.xlm_roberta.base", lang='en', test_group='span_classifier', input_data_type='qa',
            output_levels=['chunk', 'tokens', 'embeddings'], library='open_source'),
    NluTest(nlu_ref="ner.onto", lang='en', test_group='pipeline', input_data_type='generic', library='open_source'),
    NluTest(nlu_ref="en.t5.small", lang='en', test_group='seq2seq', input_data_type='generic', library='open_source',
            pipe_params = [PipeParams('t5_transformer','setTask', 'translate English to French')]),
    NluTest(nlu_ref="match.chunks", lang='en', test_group='matcher', input_data_type='generic', library='open_source'),
    NluTest(nlu_ref="en.de_identify", lang='en', test_group='hc_deidentification', input_data_type='medical', library='healthcare'),
    NluTest(nlu_ref="en.norm_drugs", lang='en', test_group='hc_drugnormalizer', input_data_type='medical', library='healthcare'),
    NluTest(nlu_ref="bert elmo", lang='en', test_group='hc_genericclassifier', input_data_type='medical', library='healthcare'),
    ...
    NluTest(nlu_ref="en.med_ner.tumour en.med_ner.radiology en.med_ner.diseases en.ner.onto", lang='en', test_group='hc_pipeline', input_data_type='medical',
            library='healthcare'),
    NluTest(nlu_ref="en.explain_doc.era", lang='en', test_group='hc_pipeline', input_data_type='medical',
            library='healthcare'),
    NluTest(nlu_ref="en.med_ner.diseases en.resolve.icd10cm.augmented_billable", lang='en', test_group='hc_resolver', input_data_type='medical',
            library='healthcare'),
    ...
    NluTest(nlu_ref="en.med_ner.clinical en.relation.zeroshot_biobert", lang='en', test_group='hc_generation', input_data_type='medical', library='healthcare',
            ...
            "REVEAL": ["{{TEST}} reveals {{PROBLEM}}."]}),PipeParams('zero_shot_relation_extraction','setMultiLabel',False)]),
    NluTest(nlu_ref="en.classify_image.convnext.tiny", lang='en', test_group='img_classifier', input_data_type='IMG_classifier', library='ocr'),
