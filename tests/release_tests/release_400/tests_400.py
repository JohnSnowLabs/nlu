...
class Test400(unittest.TestCase):
    ...
    def test_400_HC_models(self):
        ...
        te = [
            ...
            'en.med_ner.pathogen',
            'en.med_ner.living_species.token_bert',
            'en.med_ner.living_species',
            'en.med_ner.living_species.biobert',
            'en.classify.stress',
            'es.med_ner.living_species',
            'es.med_ner.living_species.bert',
            'es.med_ner.living_species.roberta',
            'es.med_ner.living_species.300',
            'es.med_ner.living_species',
            'fr.med_ner.living_species',
            'fr.med_ner.living_species.bert',
            'pt.med_ner.living_species.token_bert',
            'pt.med_ner.living_species',
            'pt.med_ner.living_species.roberta',
            'pt.med_ner.living_species.bert',
            'it.med_ner.living_species',
            'it.med_ner.living_species.bert',
            'it.med_ner.living_species',
            'cat.med_ner.living_species',
            'gal.med_ner.living_species',
            'ro.med_ner.living_species.bert',
            'ro.med_ner.clinical',
            'ro.embed.clinical.bert.base_cased',
            'ro.med_ner.deid.subentity',
            'ro.med_ner.deid.subentity.bert',
            'en.med_ner.pathogen.pipeline',
            'en.med_ner.biomedical_bc2gm.pipeline',
            'ro.deid.clinical',
            'en.med_ner.clinical_trials_abstracts.pipe',
