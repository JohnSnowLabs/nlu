...
class SentimentTrainingTests(unittest.TestCase):
    def test_sentiment_training(self):
        ...
        )  #'/home/loan/Documents/freelancework/jsl/nlu/4realnlugit/tests/datasets/sentiment_dl/AllProductReviews.csv'
    ...
    def test_sentiment_training_with_custom_embeds_sentence_level(self):
        ...
        pipe = nlu.load(
            "en.embed_sentence.small_bert_L12_768 train.sentiment",
            verbose=True,
        )
        pipe.print_info()
        pipe = pipe.fit(df_train)
