        ...
        for col in df.columns :
            if 'meta_'+ configs.output_col_prefix in col:
                ...
                if meta_col_name in df.columns :
                    ...
                    if col.split(base_meta_prefix)[-1].split('_')[1].isnumeric() and not c.spark_output_column_names[0].split('_')[-1].isnumeric(): continue
                    if col.split(base_meta_prefix)[-1].split('_')[1].isnumeric() and c.spark_output_column_names[0].split('_')[-1].isnumeric():
                ...
                else : logger.info(f"Could not find meta col for os_components={c}, col={col}. Ommiting col..")
        return result_cols
