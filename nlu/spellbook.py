...
class Spellbook:
    ...
    pretrained_models_references = {'af': {'af.embed.w2v_cc_300d': 'w2v_cc_300d',
                                    ...
                                    'es': {'es.answer_question.distil_bert.base_uncased': 'distilbert_qa_distillbert_base_spanish_uncased_finetuned_qa_tar',
                                    ...
                                    'hi': {'hi.answer_question.xlm_roberta': 'xlm_roberta_qa_autonlp_hindi_question_answering_23865268',
                                    ...
                                    'ja': {'ja.answer_question.wikipedia.bert.base': 'bert_qa_base_japanese_wikipedia_ud_head',
