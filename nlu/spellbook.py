...
class Spellbook:
    ...
    pretrained_healthcare_pipe_references = {
        'en': {
            ...
            'en.icd10cm_to_snomed': 'icd10cm_snomed_mapping',
            'en.icd10cm_to_umls': 'icd10cm_umls_mapping',
            'en.icdo_to_snomed': 'icdo_snomed_mapping',
            'en.mesh_to_umls': 'mesh_umls_mapping',
            'en.rxnorm_to_ndc': 'rxnorm_ndc_mapping',
            'en.rxnorm_to_umls': 'rxnorm_umls_mapping',
            'en.snomed_to_icd10cm': 'snomed_icd10cm_mapping',
            'en.snomed_to_icdo': 'snomed_icdo_mapping',
            'en.snomed_to_umls': 'snomed_umls_mapping',
