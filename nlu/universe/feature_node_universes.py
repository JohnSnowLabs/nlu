...
class NLP_FEATURE_NODES:  # or Mode Node?
    ...
    nodes = {
        ...
        A.ROBERTA__FOR_QUESTION_ANSWERING: NlpFeatureNode(A.ROBERTA__FOR_QUESTION_ANSWERING, [F.DOCUMENT_QUESTION, F.DOCUMENT_QUESTION_CONTEXT], [F.CLASSIFIED_SPAN]),
        ...
        # TODO SPAN COREF!
        A.SPAN_BERT_COREF_MODEL: None ,#  NlpFeatureNode(A.MULTI_DOCUMENT_ASSEMBLER, [F.RAW_QUESTION, F.RAW_QUESTION_CONTEXT], [F.DOCUMENT_QUESTION, F.DOCUMENT_QUESTION_CONTEXT]),
